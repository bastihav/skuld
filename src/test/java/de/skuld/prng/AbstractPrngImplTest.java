...
/**
 * Interface to validate the java implementation of the de.skuld.prng
 */
public abstract class AbstractPrngImplTest {
   ...
   *
   * @param seed seed
   * @return random bytes generated by original de.skuld.prng
   */
   ...
   *
   * @param seed seed
   * @return random bytes generated by replicated de.skuld.prng
   */
